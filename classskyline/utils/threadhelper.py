...
after all threads have
finished their work. It's also possible, to define callbacks to h
...
this queue as soon as they become available or andle
...
def _handle_thread_exception(request, exc_info):
    ...
    LOG.error(traceback.format_exception(*exc_info))
