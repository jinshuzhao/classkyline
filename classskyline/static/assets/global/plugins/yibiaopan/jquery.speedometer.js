	...
	$.fn.speedometer = function( options ){
		...
		var def = {
			...
			thisCss: {
				...
				fontFamily: 'Arial',
				fontWeight: '900',
				backgroundImage : "url('../../static/assets/global/plugins/yibiaopan/background.jpg')"
		...
		if ( def.limit && ( def.percentage > def.maximum || def.percentage < def.minimum ) ) {
			/* the glass cracks */
			$this.css( 'backgroundImage' , 'url("../../static/assets/global/plugins/yibiaopan/background-broken.jpg")' );
		} else {
